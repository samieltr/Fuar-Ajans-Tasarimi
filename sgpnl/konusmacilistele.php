                        ...
                        <div class="module">
						   ...
						   <div class="module">
							<div class="module-head">
								<h3>Konuşmacı Listesi</h3>
							</div>
							<br>
							<p><a href="konusmaciekle.php" class="btn btn-info">Konuşmacı Ekle</a></p>
...
while ($sonuc = $sorgu->fetch()) {
    ...
    <tr <?php echo $yon == 'sag' ? 'ml-auto' : 'mr-auto' ?>>
      <td><?= $sonuc['adsoyad'] ?></td>
      <td><?= $sonuc['alani'] ?></td>
	<td>  <a href="inc/silkonusmaci.php?id=<?= $sonuc["id"] ?>" class="btn btn-danger">Sil</a></td>
