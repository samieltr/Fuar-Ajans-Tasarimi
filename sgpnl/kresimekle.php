            ...
            <div class="row">
                ...
                <div class="span9">
					...
					<div class="control-group">
							...
							<div class="control-group">
											<label class="control-label" for="basicinput">Görsel Açıklaması :</label>
											<div class="controls">
												<input type="text" name="ustBaslik" id="ustBaslik" placeholder="Görsel Açıklamasını Buraya Girin" class="span8">
											</div>
										</div>
