...
if ($_GET) {
    ...
    $durum = $baglanti->prepare("DELETE FROM duyurular WHERE id=:id")->execute($where);
    if ($durum) {
        header("location:../duyuruliste.php"); // Eğer sorgu çalışırsa index.php sayfasına gönderiyoruz.
    }
}
?>