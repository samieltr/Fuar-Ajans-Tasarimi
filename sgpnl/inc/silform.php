...
if ($_GET) {
    ...
    $durum = $baglanti->prepare("DELETE FROM iletisim WHERE id=:id")->execute($where);
    if ($durum) {
        header("location:../iletisimformu.php"); // Eğer sorgu çalışırsa index.php sayfasına gönderiyoruz.
    }
}
?>