...
if ($_GET) {
    ...
    $durum = $baglanti->prepare("DELETE FROM galeri WHERE id=:id")->execute($where);
    if ($durum) {
        header("location:../resimgliste.php"); // Eğer sorgu çalışırsa index.php sayfasına gönderiyoruz.
    }
}
?>