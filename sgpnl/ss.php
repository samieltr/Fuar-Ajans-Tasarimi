            ...
            if (file_exists('images/' . $dosya_adi)) {
                ...
                if ($boyut > (1024 * 1024 * 2)) {
                    ...
                    if (!in_array($dosya_tipi, ['image/png', 'image/jpeg']) || !in_array($dosya_uzanti, ['png', 'jpg'])) {
                        ...
                        $sql = "INSERT INTO kayan SET foto=:foto, ustBaslik=:ustBaslik;";
                ...
                <div class="span9">
					...
					<div class="control-group">
							...
							<div class="control-group">
											 ...
											 <label for="foto">Kayan Resim</label>
										<input required type="file" name="foto" class="form-control-file" id="foto">
										</div>	
								</center>
							<div class="control-group">
											<label class="control-label" for="basicinput">Kayan Resim Açıklama :</label>
											<div class="controls">
												<input type="text" name="ustBaslik" id="ustBaslik" placeholder="Kayan Resim Açıklaması" class="span8">
											</div>
										</div>
