...
$sorgu = $baglanti->prepare("SELECT * FROM basvuru");
$sorgu->execute();
$yon = 'sag';
...
while ($sonuc = $sorgu->fetch()) {
    ...
    <tr <?php echo $yon == 'sag' ? 'ml-auto' : 'mr-auto' ?>>
	  ...
	  <td><?= $sonuc['telefon'] ?></td>
	  <td><?= $sonuc['eposta'] ?></td>
	  <td><a href="uyebak.php?id=<?= $sonuc["id"] ?>" class="btn btn-info">Görüntüle</a></td>
	<td>  
	<a href="inc/siluye.php?id=<?= $sonuc["id"] ?>" class="btn btn-danger">Sil</a></td>
